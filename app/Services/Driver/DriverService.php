...
class DriverService
{
    ...
    {
        $driver = auth('driver')->user()->load(['cities.areas', 'shops', 'vendors', 'orders', 'ratings']);
    ...
    public function updateProfile($data, $id)
    {
        ...
        return new DriverProfileResource($driver->fresh()->load(['cities.areas', 'shops', 'vendors', 'orders', 'ratings']));
    }

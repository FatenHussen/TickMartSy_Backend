...
class OneResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            // ⭐️ المصفوفة الأولى: attributes مع كل القيم
            'attributes' => $this->buildAttributes(),

            // ⭐️ المصفوفة الثانية: variants مع السعر والكمية حسب shop
    ...
    protected function buildAttributes()
    {
        ...
        return collect($result)->map(fn($values, $name) => [
            'name' => $name,
    ...
    // =========================
    // مصفوفة variants حسب shop
    // =========================
    protected function buildVariants()
    {
        return $this->variants->map(function ($variant) {
            $shopVariant = $variant->shopVariants->first(); // لأنه مفلتر على shop واحد
            ...
            return [
                ...
                'values' => $variant->attributes->mapWithKeys(fn($attr) => [

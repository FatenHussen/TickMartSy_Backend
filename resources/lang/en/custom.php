...
return [
    ...
    'category_delete_impact' => [
        ...
        'child_categories' => ':count subcategory(ies) under this category will be deleted.',
        'products' => ':count product(s) will be soft-deleted and unlinked from the category. Order history is preserved.',
        'baskets' => ':count basket(s) linked to this category will be deleted.',
        'pages' => ':count category page(s) and their sections will be deleted.',
        'recipe_links' => ':count switchable recipe item link(s) to this category will be cleared.',
    ],
    ...
    'products' => [
        ...
        'actions' => [
            ...
            'update_prices_modal_title' => 'Update Product Price and Variant Prices',
            'base_price' => 'Base Product Price',
            'variant_prices_section' => 'Variant Prices: :variant',
            'variant_price_label' => 'Variant Price: :variant',
        ...
        'form' => [
            ...
            'category_level_optional' => 'Optional',
            'category_level_hint' => 'You can stop at any level. The product is saved on the last category you pick, not necessarily the last child.',
            'category_level_optional_hint' => 'Optional — leave empty to assign the product to the previous level.',
            ...
            'images_help' => 'Replace all old images with new ones only. Old images will be kept and new images will be added to them',
                ...
                'badge_top' => 'Top Badge',
                'badge_bottom' => 'Bottom Badges',
                'top_badge_helper' => 'Only one badge can be selected for the top section.',
                'bottom_badges_helper' => 'You can select multiple badges for the bottom section.',
                'add_badge' => '➕ Add Badge',
            ...
            'unit' => 'Unit',
            'quantity_help' => 'Quantity available for this variant',
            'price_in_shop' => 'Price',
            'price_help' => 'Selling price for this variant',
            'add_shop' => '➕ Add Shop',
            'new_shop' => 'New Shop',
    ...
    'inventory' => [
        ...
        'update_modal_title' => 'Update Variant Quantities',
        'variant_section_title' => 'Variant: :variant',
        'variant_quantity_label' => 'Variant: :variant',
        'shop_variant_quantity_label' => 'Shop: :shop | Variant: :variant',
        'no_variant_stock_title' => 'No variants found for this product',
        'no_variant_stock_body' => 'Please add product variants first.',

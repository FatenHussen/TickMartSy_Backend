...
return [
    ...
    'duplicate_unique_value' => 'هذه القيمة مستخدمة مسبقاً (SKU أو حقل فريد). غيّرها ثم أعد المحاولة.',
    ...
    'category_delete_impact' => [
        ...
        'child_categories' => 'سيتم حذف :count فئة فرعية تابعة لهذه الفئة.',
        'products' => 'سيتم إخفاء :count منتج (حذف ناعم) وفك ارتباطها بالفئة. سجل الطلبات يبقى محفوظاً.',
        'baskets' => 'سيتم حذف :count سلة مرتبطة بهذه الفئة.',
        'pages' => 'سيتم حذف :count صفحة فئة وأقسامها.',
        'recipe_links' => 'سيتم فك ارتباط :count عنصر وصفة قابل للتبديل بهذه الفئة.',
    ],
    ...
    'shops' => [
        ...
        'is_default' => 'المتجر',
        'is_default_help' => 'لكل بائع متجر واحد فقط',
        'vendor_already_has_shop' => 'لكل بائع متجر واحد فقط. لا يمكن إنشاء متجر إضافي.',
        'hours' => 'الساعات',
        'add_day' => 'إضافة يوم',
    ...
    'products' => [
        ...
        'actions' => [
            ...
            'update_prices_modal_title' => 'تعديل سعر المنتج وأسعار المتغيرات',
            'base_price' => 'السعر الأساسي للمنتج',
            'variant_prices_section' => 'أسعار المتغير: :variant',
            'variant_price_label' => 'سعر المتغير: :variant',
        ...
        'sections' => [
            ...
            'attributes' => 'الخصائص',
            'shop_availability' => 'توفر المتغير في المتجر',
            'statistics' => 'الإحصائيات',
            'category_details' => 'تفاصيل الفئة',
            'extra_details' => 'تفاصيل إضافية',
        ...
        'form' => [
            ...
            'category_level_optional' => 'اختياري',
            'category_level_hint' => 'يمكنك التوقف عند أي مستوى. المنتج يُحفظ على آخر فئة تختارها، وليس بالضرورة آخر ابن.',
            'category_level_optional_hint' => 'اختياري — اتركه فارغاً لإسناد المنتج للمستوى السابق.',
            ...
            'quantity_help' => 'الكمية المتوفرة لهذا المتغير',
            'price_in_shop' => 'السعر',
            'price_help' => 'سعر البيع لهذا المتغير',
            'add_shop' => '➕ إضافة متجر',
            'new_shop' => 'متجر جديد',
        ...
        'variants' => [
            ...
            'shop_variants' => [
                'title' => 'توفر المتغير في المتجر',
                'description' => 'المتغيّر يُربَط تلقائياً بمتجر البائع',
                'shop_name' => 'اسم المتجر',
                'quantity' => 'الكمية المتاحة',
                'quantity_help' => 'عدد الوحدات المتوفرة',
                'price' => 'السعر',
                'price_help' => 'سعر هذا المتغيّر',
                'unit' => 'وحدة',
                'new' => 'متجر',
                'add' => '➕ إضافة متجر',
    ...
    'inventory' => [
        ...
        'update_modal_title' => 'تعديل كميات المتغيرات',
        'variant_section_title' => 'المتغير: :variant',
        'variant_quantity_label' => 'المتغير: :variant',
        'shop_variant_quantity_label' => 'الشوب: :shop | المتغير: :variant',
        'no_variant_stock_title' => 'لا توجد متغيرات لهذا المنتج',
        'no_variant_stock_body' => 'أضف متغيرات المنتج أولاً.',

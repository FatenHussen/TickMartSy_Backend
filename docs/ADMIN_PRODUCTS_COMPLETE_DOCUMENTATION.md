...
| `media` | required, array, min:1 | صورة واحدة على الأقل |
| `media.*` | required, image, max:5120 | حجم أقصى 5MB |
...
نعم، لكن المنتج لن يكون متاحاً للشراء حتى يتم ربطه بمتجر عبر `shop_variants`.

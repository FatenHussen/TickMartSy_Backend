...
> المرجع التفصيلي: `CUSTOM_ORDER_REQUESTS_WEB.md`
...
| `CUSTOM_ORDER_REQUESTS_WEB.md` | طلب سريع: قسم الهوم + الفلو |
| `FRONTEND_WEB_APP_DOWNLOAD_AND_PRICES.md` | نص تحميل التطبيق + عرض الأسعار |

...
بالتطبيق: اعرضوا العنوان والوصف ونص الزر والرابط إن وُجدت — مو الصورة وحدها. `?? ''` للحقول الناقصة.  
بعد مسح الحقول من الداشبورد: [`FLUTTER_BANNER_CLEAR_FIELDS.md`](./FLUTTER_BANNER_CLEAR_FIELDS.md)
...
أي بنر قد ينقصه عنوان أو وصف أو زر أو رابط — `?? ''` مو إخفاء الكارد.

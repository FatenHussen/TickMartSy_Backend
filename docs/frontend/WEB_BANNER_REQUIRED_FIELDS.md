...
على الموقع: اعرضوا العنوان والوصف ونص الزر والرابط — مو الصورة وحدها.
...
البنرات الجديدة من الأدمن ما عاد تنحفظ ناقصة. بنرات قديمة قد تبقى بلا بعض الحقول — استخدموا fallback فاضي مو تخفوا الكارد.
